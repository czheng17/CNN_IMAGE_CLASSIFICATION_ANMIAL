...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 21:11:54 2017
...
def run_training():
    ...
    train_dir = '/home/czheng17/Documents/Projects/SpyderProjects/cat_and_dog/data/train/'
    logs_train_dir = '/home/czheng17/Documents/Projects/SpyderProjects/cat_and_dog/logs/train/'
...
#    image_array = get_one_image(train)
    ...
    train_dir = '/home/czheng17/Documents/Projects/SpyderProjects/cat_and_dog/test_image/dog.5.jpeg'
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            if max_index==0:
                print('这是一只猫的概率 %.6f' %prediction[:, 0])
            else:
                print('这是一只狗的概率 %.6f' %prediction[:, 1])
